...
console.log(message.style.height); // not found because this is not inline
console.log(message.style.backgroundColor); // this is found because it is inline
...
// don't use this because this will overwrite everything:
// logo.className = 'yoyo'
...
//h11.closest('h1').style.background = 'var(--gradient-primary)';
